...
public class SearchFriendsFragment extends BaseFragment {
    ...
    private PagingConfig usersPagingConfig;
    ...
    private void initContentData() {
        ...
        usersPagingConfig =  new PagingConfig(
                3,    // Page size (number of items to load per page)
                10,   // Initial load size hint (number of items to load initially)
                false // Enable or disable placeholders
        );;
    }
